export const HttpResponses: Record<number, string | ((entity?: string) => string)> = {
    400: (entity?: string) => `Solicitud incorrecta para ${entity || 'la entidad'}. Verifique los datos ingresados.`,
    ...
    404: (entity?: string) => `${entity || 'El recurso'} no fue encontrado. Verifique el ID o la URL.`,
